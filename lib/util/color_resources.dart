...
class ColorResources {
  ...
  static Color getBalanceTextColor() {
    // return Get.isDarkMode ? const Color(0xFFd7d7d7) : const Color(0xFF393939);
        return Get.isDarkMode ? const Color(0xFF393939) : Color.fromARGB(255, 255, 255, 255);

  }

static Color getSelectedTextColor() { //229D7A 229D7A
    return Get.isDarkMode ? const Color(0xFF393939) : Color(0xFF229D7A);
  }

  static Color getSplashTextColor() { //229D7A 229D7A
    return Get.isDarkMode ? const Color(0xFF393939) : Color.fromARGB(255, 2, 109, 78);
  }

  static Color getSuggestedTitleTextColor() { //229D7A 229D7A
    return Get.isDarkMode ? const Color(0xFF393939) : Color.fromARGB(255, 255, 255, 255);
  }

  static Color getSelectedTextBackgroundColor() {
    return Get.isDarkMode ? const Color(0xFF393939) : Color(0xFFA7E6D3);
  }
