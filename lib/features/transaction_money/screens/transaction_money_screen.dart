...
import 'package:Sanaa/features/transaction_money/widgets/contact_list_widget.dart';
...
import 'package:Sanaa/features/transaction_money/widgets/scan_button_widget.dart';
  ...
  Widget build(BuildContext context) {
     ...
     return Scaffold(
      ...
      body: GetBuilder<ContactController>(builder: (contactController)=> Builder(
        builder: (context) {
          print('list ====> ${contactController.cashOutSuggestList}');
